...
def get_args():
    ...
    parser.add_argument("--clip_update_parameters", type=list, default=["prompt_deep"])#,"cloth_class_embedding"
    ...
    parser.add_argument('--ablation', default="no", type=str,
                        choices=['onlyfeat','featandall','allandinv','abla-inv','featandclo','VLP','noattr'],
