...
def main():
    ...
    optimizer = optim.AdamW([{'params':params} for params in clip_params]+[{'params':params} for params in clip_params_m]+[{'params':model.parameters()}],lr=lr, weight_decay=args.weight_decay)#,{'params':clip_params[1]}
    ...
    for epoch in range(start_epoch, args.max_epoch):
        ...
        htriloss3 = train_fire.train(args, epoch + 1, dataset, train_loader, model,ViT_model,ViT_model_m, 
                         optimizer, scheduler, class_criterion, metric_criterion, triplet_hard_criterion,lamd,use_gpu)#classifier,, FFM_criterion
