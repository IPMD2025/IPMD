...
class Celeb_light(object):
    ...
    def __init__(self, dataset_root='data',dataset_filename='Celeb-reID-light', **kwargs):
        ...
        train, num_train_pids, num_train_imgs, num_train_clothes, pid2clothes = \
            self._process_dir_train(self.train_dir,pid2label, clothes2label, pid2clothes,imgdir2attribute)
    ...
    def _process_dir_train(self, dir_path,pid2label, clothes2label, pid2clothes,imgdir2attribute):
